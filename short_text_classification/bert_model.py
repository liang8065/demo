...
def test_bert():
    ...
    # 配置
    bert_config = BertConfig(vocab_size=21128, hidden_size=hidden_size, num_hidden_layers=12,
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids, labels, num_labels, use_one_hot_embeddings):
    ...
    with tf.variable_scope("loss"):
        ...
        print("probabilities:",probabilities.shape,";per_example_loss:",per_example_loss.shape,";loss:",loss.shape)
